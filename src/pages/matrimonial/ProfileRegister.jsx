  ...
  const uploadFiles = async () => {
    ...
    try {
      ...
      if (biodata) {
        ...
        const { error } = await supabase.storage
          .from('matrimonial-biodatas')
          .upload(fileName, biodata);
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-pink-100 flex items-center justify-center">
        <div className="text-center bg-white p-8 rounded-xl shadow-lg max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            Your payment was successful and your profile is now active. You can now browse other profiles.
          </p>
          <button
            onClick={() => navigate('/matrimonial/browse')}
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-pink-100 flex items-center justify-center px-4">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full">
          ...
          <p className="text-gray-600 mb-6">
            Your profile has been created. Please complete the payment of ₹500 to activate your profile and access all features.
          </p>
