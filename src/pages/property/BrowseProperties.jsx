              ...
              <div className="p-6">
                {selectedProperty.image_urls && selectedProperty.image_urls.length > 0 && (
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    {selectedProperty.image_urls.map((url, index) => (
                      <img
                        key={index}
                        src={url}
                ...
                {selectedProperty.video_urls && selectedProperty.video_urls.length > 0 && (
                  <div className="mb-6">
                    <h3 className="text-lg font-bold mb-3">Property Videos</h3>
                    <div className="grid grid-cols-1 gap-4">
                      {selectedProperty.video_urls.map((url, index) => (
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-bold text-gray-800 mb-2">Property Type</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-800 mb-2">Area/Size</h3>
                    <p className="text-gray-600">{selectedProperty.area_size} sq. ft.</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-gray-800 mb-2">Price</h3>
                    <p className="text-3xl font-bold text-green-600">₹{parseInt(selectedProperty.selling_price).toLocaleString()}</p>
                  </div>
                  <div>
                  ...
                  <div className="bg-blue-50 rounded-lg p-4">
                    <h3 className="text-lg font-bold text-gray-800 mb-2">Seller Contact</h3>
                    <p className="text-gray-600"><strong>Name:</strong> {selectedProperty.sellers?.full_name}</p>
                    <p className="text-gray-600"><strong>Phone:</strong> {selectedProperty.sellers?.phone}</p>
                    <p className="text-gray-600"><strong>Email:</strong> {selectedProperty.sellers?.email}</p>
                  </div>
                </div>
              </div>
            </div>
