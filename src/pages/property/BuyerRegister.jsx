  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post('/api/property/buyers', {
        ...
        property_type: formData.propertyType, preferred_location: formData.preferredLocation,
        area_size: formData.areaSize, budget_range: formData.budgetRange,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input type="tel" name="phone" value={formData.phone} onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" required />
                <OTPVerification type="phone" value={formData.phone} onVerified={handleVerified} label="Phone" />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" name="areaSize" value={formData.areaSize} onChange={handleChange}
              ...
              <div className="md:col-span-2">
                ...
                <textarea name="additionalRequirements" value={formData.additionalRequirements} onChange={handleChange}
                  rows="4" placeholder="Any specific requirements..."
